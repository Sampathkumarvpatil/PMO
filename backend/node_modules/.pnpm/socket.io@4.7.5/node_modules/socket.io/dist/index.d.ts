...
import { ExtendedError, Namespace, ServerReservedEventsMap } from ".pnpm/socket.io@4.7.5/node_modules/socket.io/dist/namespace";
import { Adapter, Room, SocketId } from "socket.io-adapter";
import * as parser from "socket.io-parser";
import type { Encoder } from "socket.io-parser";
import { Socket, DisconnectReason } from ".pnpm/socket.io@4.7.5/node_modules/socket.io/dist/socket";
import type { BroadcastOperator, RemoteSocket } from ".pnpm/socket.io@4.7.5/node_modules/socket.io/dist/broadcast-operator";
import { EventsMap, DefaultEventsMap, EventParams, StrictEventEmitter, EventNames, DecorateAcknowledgementsWithTimeoutAndMultipleResponses, AllButLast, Last, RemoveAcknowledgements, EventNamesWithAck, FirstNonErrorArg } from ".pnpm/socket.io@4.7.5/node_modules/socket.io/dist/typed-events";
...
export declare class Server<ListenEvents extends EventsMap = DefaultEventsMap, EmitEvents extends EventsMap = ListenEvents, ServerSideEvents extends EventsMap = DefaultEventsMap, SocketData = any> extends StrictEventEmitter<ServerSideEvents, RemoveAcknowledgements<EmitEvents>, ServerReservedEventsMap<ListenEvents, EmitEvents, ServerSideEvents, SocketData>> {
     ...
     */
    to(room: Room | Room[]): BroadcastOperator<import(".pnpm/socket.io@4.7.5/node_modules/socket.io/dist/typed-events").DecorateAcknowledgementsWithMultipleResponses<EmitEvents>, SocketData>;
    /**
     ...
     * @return a new {@link BroadcastOperator} instance for chaining
     */
    in(room: Room | Room[]): BroadcastOperator<import(".pnpm/socket.io@4.7.5/node_modules/socket.io/dist/typed-events").DecorateAcknowledgementsWithMultipleResponses<EmitEvents>, SocketData>;
    /**
     ...
     * @return a new {@link BroadcastOperator} instance for chaining
     */
    except(room: Room | Room[]): BroadcastOperator<import(".pnpm/socket.io@4.7.5/node_modules/socket.io/dist/typed-events").DecorateAcknowledgementsWithMultipleResponses<EmitEvents>, SocketData>;
    /**
     ...
     * @return a new {@link BroadcastOperator} instance for chaining
     */
    compress(compress: boolean): BroadcastOperator<import(".pnpm/socket.io@4.7.5/node_modules/socket.io/dist/typed-events").DecorateAcknowledgementsWithMultipleResponses<EmitEvents>, SocketData>;
    /**
     ...
     * @return a new {@link BroadcastOperator} instance for chaining
     */
    get volatile(): BroadcastOperator<import(".pnpm/socket.io@4.7.5/node_modules/socket.io/dist/typed-events").DecorateAcknowledgementsWithMultipleResponses<EmitEvents>, SocketData>;
    /**
     ...
     * @return a new {@link BroadcastOperator} instance for chaining
     */
    get local(): BroadcastOperator<import(".pnpm/socket.io@4.7.5/node_modules/socket.io/dist/typed-events").DecorateAcknowledgementsWithMultipleResponses<EmitEvents>, SocketData>;
    /**
     ...
     * @param timeout
     */
    timeout(timeout: number): BroadcastOperator<import(".pnpm/socket.io@4.7.5/node_modules/socket.io/dist/typed-events").DecorateAcknowledgements<import(".pnpm/socket.io@4.7.5/node_modules/socket.io/dist/typed-events").DecorateAcknowledgementsWithMultipleResponses<EmitEvents>>, SocketData>;
    /**
...
export { Event } from ".pnpm/socket.io@4.7.5/node_modules/socket.io/dist/socket";
