import { Socket } from ".pnpm/socket.io@4.7.5/node_modules/socket.io/dist/socket";
import type { Server } from ".pnpm/socket.io@4.7.5/node_modules/socket.io";
import { EventParams, EventNames, EventsMap, StrictEventEmitter, DefaultEventsMap, DecorateAcknowledgementsWithTimeoutAndMultipleResponses, AllButLast, Last, DecorateAcknowledgementsWithMultipleResponses, DecorateAcknowledgements, RemoveAcknowledgements, EventNamesWithAck, FirstNonErrorArg, EventNamesWithoutAck } from ".pnpm/socket.io@4.7.5/node_modules/socket.io/dist/typed-events";
import type { Client } from ".pnpm/socket.io@4.7.5/node_modules/socket.io/dist/client";
import type { Adapter, Room, SocketId } from "socket.io-adapter";
import { BroadcastOperator } from ".pnpm/socket.io@4.7.5/node_modules/socket.io/dist/broadcast-operator";
...
export declare class Namespace<ListenEvents extends EventsMap = DefaultEventsMap, EmitEvents extends EventsMap = ListenEvents, ServerSideEvents extends EventsMap = DefaultEventsMap, SocketData = any> extends StrictEventEmitter<ServerSideEvents, RemoveAcknowledgements<EmitEvents>, NamespaceReservedEventsMap<ListenEvents, EmitEvents, ServerSideEvents, SocketData>> {
     ...
     * }
     */
    fetchSockets(): Promise<import(".pnpm/socket.io@4.7.5/node_modules/socket.io/dist/broadcast-operator").RemoteSocket<EmitEvents, SocketData>[]>;
    /**
