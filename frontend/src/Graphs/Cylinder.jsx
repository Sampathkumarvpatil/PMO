...
const CylinderChartComponent = () => {
    ...
    const { workEfficiencyRatio, plannedWorkHours, workHoursUsed } = location.state || { workEfficiencyRatio: 0, plannedWorkHours: 0, workHoursUsed: 0 };
    ...
    data: [
        ...
        },
        {
            ...
            y: workHoursUsed,workEfficiencyRatio,
