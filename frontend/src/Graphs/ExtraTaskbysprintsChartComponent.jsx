...
const ExtraTaskbysprintsChartComponent = ({sidebarToggle}) => {
    ...
    const highestValue = Math.max(...selectedSprints.map(sprint => sprint.extraTasksAdded)) + 10;
    ...
    const chartOptions = {
        ...
        series: [{
            ...
            data: selectedSprints.map(sprint => ({
                ...
                extraTaskRatio: (sprint.extraTasksAdded / sprint.plannedTasks * 100).toFixed(3),
                color: {
