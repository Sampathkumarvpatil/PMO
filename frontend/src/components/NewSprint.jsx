...
const NewSprint = ({ sidebarToggle }) => {
  ...
  return (
    <div
      className={`flex justify-center items-center h-screen bg-gray-100 transition-all duration-300 ${
      ...
      <div className="w-96 p-6 shadow-lg rounded-md container">
        ...
        <div className="mt-5 text-center">
          <button
            ...
            className="border-none font-semibold text-white rounded-lg bg-indigo-500 px-4 py-2"
            style={{
              background:
