        ...
        <section className={`transition-all duration-300 ${sidebarToggle ? "ml-0" : "ml-64"
            ...
            <div className="ml-12 mr-8" >
                <div className="flex justify-between">
                    <div className="mt-8 border shadow px-4 py-6 flex-1" style={{ backgroundColor: '#b6e7e9' }}>
                    ...
                    <div className="mt-8 border shadow px-4 py-6 flex-1" style={{ backgroundColor: '#c0ebc0' }}>
                        <h2 className="text-xl mb-4">Number of Tests Passed</h2>
                        <p className="text-2xl" style={{ color: 'green' }}>0</p>
                    </div>
                    <div className="mt-8 border shadow px-4 py-6 flex-1" style={{ backgroundColor: '#efc7c7' }}>
