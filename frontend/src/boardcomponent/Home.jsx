...
const Home = ({sidebarToggle}) => {
  ...
  return (
    <div className={`hero w-full flex justify-center items-center h-screen bg-gray-100 transition-all duration-300 ${sidebarToggle ? "ml-0" : "ml-64"}`}>
      <div className="bg-transparent bg-white relative left-[50%] rounded-lg shadow-2xl border-[4px] border-gray-400 p-10 max-w-md w-full">
        <div className="mb-6">
          <input
            type="text"
